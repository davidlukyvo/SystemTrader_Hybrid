/* ══════════════════════════════════════════════════════════
   COINGECKO UNIVERSE LAYER — normalized universe scan
   Dùng để quét universe theo market cap, volume, ATH distance.
...
const CG = {
  ...
  async fetchUniverseWindow({ minM=5, maxM=100, pages=3, pageHintKey='', force=false, background=false } = {}) {
    ...
    deduped.sort((a, b) => Number(a.market_cap || 0) - Number(b.market_cap || 0));
    return deduped;
  },
