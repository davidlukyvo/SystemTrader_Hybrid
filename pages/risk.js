  ...
  <div class="grid-2" style="align-items:start">
    ...
    <div class="card">
      ...
      <div class="form-group">
        ...
        <input class="form-input font-mono" id="rAcct" type="number" value="10000" oninput="calcRisk()"/>
      </div>
      <div class="form-group">
  ...
  res.innerHTML = `
    <div class="grid-2 gap-8 mb-16">
      ...
      <div style="text-align:center;padding:16px;border-radius:10px;background:rgba(0,229,255,.08);border:1px solid rgba(0,229,255,.2)">
        ...
        <div class="font-mono fw-800 text-cyan" style="font-size:22px">${qty.toLocaleString(undefined,{maximumFractionDigits:0})}</div>
