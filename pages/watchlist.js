...
function renderWatchlist() {
  ...
  <div class="card mb-20">
    <div style="display:flex;justify-content:space-between;align-items:center;gap:8px;flex-wrap:wrap">
      <div>
        ...
        <div class="text-sm text-muted">Best = READY hoặc smart-scalp mạnh thật · Watch = SCALP_READY + PLAYABLE + PROBE + EARLY · Avoid = AVOID / rejected · smart execution không leak tier</div>
      </div>
  ...
  <div class="watchlist-cols">
    ${renderWLColumn('best', '🟢 Best Entry', 'Chỉ setup full-quality, không leak từ probe/scalp')}
    ${renderWLColumn('watch', '🟡 Theo Dõi', 'Scalp/playable/probe cần thêm xác nhận')}
